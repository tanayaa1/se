...
# Context processor for getting country information based on IP address
...
# Context processor for formatting duration
@app.context_processor
def utility_processor():
...
# Function to get header value from email data
...
# Flask route for handling the main index page
...
def index():
    if request.method == 'POST':
        ...
        # Filter received headers with 'from' or 'by' information
        if received:
...
if __name__ == '__main__':
    ...
    # Set the Flask app in debug mode based on command line arguments
